...
func templatesBodyContentArticleArticleTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/body/content/article/article.tmpl", size: 919, mode: os.FileMode(420), modTime: time.Unix(1461591614, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func templatesBodyNavbarTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/body/navbar.tmpl", size: 2125, mode: os.FileMode(420), modTime: time.Unix(1461591614, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
